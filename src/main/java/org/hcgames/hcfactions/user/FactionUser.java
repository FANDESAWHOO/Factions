...
public class FactionUser implements Mongoable {
    ...
    public FactionUser(Document document){
        backing = document;
        if(backing.containsKey("filteredTypes")) backing.put("filteredTypes", null);
    }
    ...
    public void addKill(String whom, UUID whomUUID, @Nullable String item, EntityDamageEvent.DamageCause cause){
        ...
        try{
            ...
            if(backing.containsKey("kills")) kills = backing.get("kills", Document.class);
			else{
                kills = new Document();
                backing.put("kills", kills);
            }
    ...
    public void addDeath(String by, UUID byUUID, @Nullable String item, EntityDamageEvent.DamageCause cause){
        ...
        try{
            ...
            if(backing.containsKey("deaths")) deaths = backing.get("deaths", Document.class);
			else{
                deaths = new Document();
                backing.put("deaths", deaths);
            }
    ...
    public void incrementOre(Material material){
        ...
        try{
            Document ores;
            if(backing.containsKey("ores")) ores = backing.get("ores", Document.class);
			else{
                ores = new Document();
    ...
    public void setFiltered(Material material, boolean state){
        ...
        try{
            ...
            if(state) filtered.add(material.name());
			else filtered.remove(material.name());
    ...
    boolean needsSaving(){
        lock.writeLock().lock();
        try{
            if(!backing.containsKey("lastSaveHash")) return true;
