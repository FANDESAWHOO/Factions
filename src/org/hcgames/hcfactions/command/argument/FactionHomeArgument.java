    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (factionAt.isSafezone()) {
            ...
            switch (player.getWorld().getEnvironment()) {
                case THE_END:
                    name = "End";
                    millis = plugin.getConfiguration().getFactionHomeTeleportDelayEnd();
                    break;
                case NETHER:
                    name = "Nether";
                    millis = plugin.getConfiguration().getFactionHomeTeleportDelayNether();
                    break;
                case NORMAL:
                    name = "Overworld";
                    millis = plugin.getConfiguration().getFactionHomeTeleportDelayNormal();
                    break;
                default:
